...
const (
	ShortenerService_ShortenURL_FullMethodName   = "/shortener.v1.ShortenerService/ShortenURL"
	ShortenerService_ExpandURL_FullMethodName    = "/shortener.v1.ShortenerService/ExpandURL"
